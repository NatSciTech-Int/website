...
export const metadata: Metadata = {
  title: "Physics Articles",
  description: "Explore our collection of physics articles covering quantum mechanics, time travel, and more.",
  openGraph: {
    title: "Physics Articles | NatSciTech Blog",
    description: "Explore our collection of physics articles covering quantum mechanics, time travel, and more.",
  },
}
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-6 text-white">Physics Articles</h1>
            <p className="text-white/80 text-lg">
              Explore the fundamental laws that govern the universe, from quantum mechanics to time travel theories.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="p-6 md:w-2/3">
                    ...
                    <p className="text-white/80 mb-4">
                      Exploring the theories and work of physicist Ronald Mallett on time travel through circulating
                      light beams and closed timelike curves.
                    </p>
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        <p className="text-white/80 text-sm">Joshua Fung</p>
                      </div>
                    </div>
                    <Link
